...
deck_5: [["Which two countries joined the EEC at the same time as the UK", "Ireland (Eire) and Denmark"], ["What name is given to a word that reads the same forwards and backwards", "Palindrome"], ["What type of oil is used to strengthen cricket bats", "Linseed Oil"], ["From which flower is the drug Digitalis obtained", "Fox Glove"], ["What is the highest hand in a game of Poker", "Royal Flush"], ["Lascaux in Southern France is most famously known for what", "Ancient Cave Paintings"], ["What is the traditional gift given on a 15th anniversary", "Crystal"], ["Who was the Roman God of War", "Mars"], ["Which ancient city was discovered by Hirham Bingham", "Machu Picchu"], ["Which two cities were destroyed by Vesuvius in AD79", "Pompeii and Herculaneum"]],
